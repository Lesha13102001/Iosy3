...
class Ui_Dialog_adddiscount(object):
    def setupUi(self, Dialog_adddiscount):
        ...
        Dialog_adddiscount.setObjectName("Dialog_adddiscount")
        Dialog_adddiscount.resize(1141, 709)
        self.tableWidget = QtWidgets.QTableWidget(Dialog_adddiscount)
        ...
        self.err = 0
        self.retranslateUi(Dialog_adddiscount)
        QtCore.QMetaObject.connectSlotsByName(Dialog_adddiscount)

    def retranslateUi(self, Dialog_adddiscount):
        _translate = QtCore.QCoreApplication.translate
        Dialog_adddiscount.setWindowTitle(_translate("Dialog_adddiscount", "Добавить"))
        ...
        item.setText(_translate("Dialog_adddiscount", "Добавить"))
        item = self.tableWidget.horizontalHeaderItem(count)
        item.setText(_translate("Dialog_adddiscount", "Вернуться назад"))
        ...
        def Lets():
            try:
                ...
                cursor = connection.cursor()
                with connection.cursor() as cursor:
                    insert_query = "INSERT INTO `discount` (" + inf_x + ") VALUES (" + inf + ");"
                    print(insert_query)
